...
List<JSPopularCompanyModel> getFilteredResultsData() {
  ...
  filteredResultsList
      .add(JSPopularCompanyModel(totalDays: "4 days ago ", companyName: "Android Developer", selectSkill: false, totalReview: "Jack Smit", companyImage: "\$60000 - \80000 a year", isBlocked: false));
  filteredResultsList
      .add(JSPopularCompanyModel(totalDays: "5 days ago ", companyName: "Flutter Developer", selectSkill: false, totalReview: "dnvod25", companyImage: "\$70000 - \$90000 a year", isBlocked: false));
  filteredResultsList
      .add(JSPopularCompanyModel(totalDays: "6 days ago ", companyName: "Java Developer", selectSkill: false, totalReview: "Denni Jhon", companyImage: "\$35000 - \$50000 a year", isBlocked: false));
  filteredResultsList
      .add(JSPopularCompanyModel(totalDays: "6 days ago ", companyName: "Php Developer", selectSkill: false, totalReview: "Devid Bettely", companyImage: "\$35000 - \$40000 a year", isBlocked: false));
  filteredResultsList
      .add(JSPopularCompanyModel(totalDays: "Today", companyName: "UX DESIGNER - REMOTE", selectSkill: false, totalReview: "dnvod25", companyImage: "\$35000 - \$40000 a year", isBlocked: false));
  filteredResultsList
      .add(JSPopularCompanyModel(totalDays: "6 days ago", companyName: "UX/UI Designer", selectSkill: false, totalReview: "65jhbsd", companyImage: "\$50000 - \$60000 a year", isBlocked: false));
  filteredResultsList
      .add(JSPopularCompanyModel(totalDays: "10 days ago ", companyName: "Senior UX Designer ", selectSkill: false, totalReview: "Red Cloud", companyImage: "\$10000 - \$25000 a year", isBlocked: false));
  filteredResultsList.add(
      JSPopularCompanyModel(totalDays: "2 days ago ", companyName: "Junior UI/UX Designer", selectSkill: false, totalReview: "Bench Samuels", companyImage: "\$30000 - \$35000 a year", isBlocked: false));
